...
1. Extract the downloaded plugin and upload to the '/wp-content/plugins/' directory
2. Activate the plugin through the 'Plugins' screen in your WordPress admin area
3. You will see an icon of data-locker on the Content Editor of Post or Pages or any Custom Posts.
4. Enter Email id and License Key in License Tab (skip this if using Free version)
...
1. Data Locker Icon ShortCode
2. Data Locker Box to lock data
3. License Key Checking
4. Stats
5. Settings
6. Standalone Installation
7. Standalone Admin
8. Standalone Page Code
